...
def test_mlp(learning_rate=0.01, L1_reg=0.00, L2_reg=0.0001, n_epochs=1000,
   ...
   """
    ...
    patience = 10000 * 2 # look as this many examples regardless
                ...
                if this_validation_loss < best_validation_loss:
                    ...
                    print(('     epoch %i, minibatch %i/%i, test error of '
                          ...
                          (epoch, minibatch_index + 1, n_train_batches,
                           test_score * 100.))
		    #with open('../data/mlp_music_model.pkl', 'wb') as f:
...
def predict(dataset, n_hidden, n_in, n_out):
    ...
    classifier.params, classifier.logRegressionLayer.y_pred, classifier.input = cPickle.load(open('../data/mlp_music_model.pkl'))
...
if __name__ == '__main__':
    ...
    test_mlp(learning_rate=0.01, L1_reg=0.00, L2_reg=0.0001, n_epochs=1000,
             dataset='../data/k_mnist.pkl.gz', batch_size=500, n_hidden=500,
             mlp_in=576,mlp_out=2)
