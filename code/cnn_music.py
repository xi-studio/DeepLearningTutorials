...
from logistic_music import LogisticRegression, load_data
from mlp_music import HiddenLayer
...
def evaluate_lenet5(learning_rate=0.05, n_epochs=200,
    ...
    layer0_input = x.reshape((batch_size, 1, 26, 26))
    ...
    layer0 = LeNetConvPoolLayer(
        rng,
        input=layer0_input,
        image_shape=(batch_size, 1, 26, 26),
    ...
    layer1 = LeNetConvPoolLayer(
        rng,
        input=layer0.output,
        image_shape=(batch_size, nkerns[0], 11, 11),
        filter_shape=(nkerns[1], nkerns[0], 3, 3),
        poolsize=(2, 2)
    )
   

    #layerNew = LeNetConvPoolLayer(
    #    rng,
    #    input=layer1.output,
    #    image_shape=(batch_size, nkerns[1], 132, 132),
    ...
    # or (50, 50 * 4 * 4) = (500, 800) with the default values.
            ...
            if (iter + 1) % validation_frequency == 0:
                ...
                if this_validation_loss < best_validation_loss:
                    ...
                    print(('     epoch %i, minibatch %i/%i, test error of '
                          ...
                          (epoch, minibatch_index + 1, n_train_batches,
                           test_score * 100.))
                    #with gzip.open('../data/cnn_music_model.pkl.gz', 'w') as f:
...
if __name__ == '__main__':
    evaluate_lenet5(learning_rate=0.01,batch_size=500)
    #predict()
